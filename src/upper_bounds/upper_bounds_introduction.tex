...
To show the upper bound of the expressive power of PHFL$^k$ is \exptime{$k$} we make a reduction from the model checking
...
To show that the upper bound of the expressive power of PHFL$^{k + 1}_{tail}$ is \expspace{$k$} we can make a reduction from the semantics of
