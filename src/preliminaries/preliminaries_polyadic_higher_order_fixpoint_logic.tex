...
type semantic, i.e. $\eta(X) \in \mathcal{T}\llbracket\tau\rrbracket$ for $X$ of type $\tau$. Let $\Phi$ be a
...
$\mathcal{T}\llbracket\tau\rrbracket$ as explained in Figure~\ref{figure:phfl-semantic}.

\begin{figure}
    \caption{Semantics of PHFL formulas.}
    \label{figure:phfl-semantic}
    \begin{align*}
