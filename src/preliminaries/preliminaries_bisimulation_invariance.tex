...
following relation describes these states that have a sufficient similar behaviour.
...
\begin{definition}{\cite{otto1999bisimulation}}
    ...
    \mathcal{T} \to \mathcal{T}'$ between $\mathcal{T}$ and another LTS $\mathcal{T'}$ maps tuples not in $\mathcal{Q}^{\mathcal{T}}$ to tuples not in $\mathcal{Q}^{\mathcal{T'}}$.
\end{definition}
