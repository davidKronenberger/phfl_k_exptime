...
In this chapter we want to establish that the lower bounds of the expressive power of PHFL$^k$ and PHFL$^k_{tail}$ is \exptime{$k$} and \expspace{$k$} respectively. The
