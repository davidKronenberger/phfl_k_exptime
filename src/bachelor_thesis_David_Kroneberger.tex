...
\title{Comparing two different classes\vspace{0.2cm} of deterministic\vspace{0.2cm}
...
\input{basic_definitions.tex}

\input{tiling_systems/tiling_systems_introduction.tex}

\input{diag_drec/diag_drec_introduction.tex}

\input{drec/drec_introduction.tex}

\input{deterministic_two-dimensional_on-line_tesselation_automata.tex}

\input{comparing_drec_and_diag_drec.tex}
